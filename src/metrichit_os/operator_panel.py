...
<body><h1>MetricHit</h1><div class="tabs"><button data-view="artem" class="active">Рекомендации Артёма</button><button data-view="idea">Мои идеи</button><button data-view="tasks">Задачи</button><button data-view="memory">Память</button></div>
