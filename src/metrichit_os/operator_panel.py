...
<style>.entry:target{border:2px solid #38c7d4;background:#123745;box-shadow:0 0 0 4px #1a6474}</style><body><h1>MetricHit</h1><div class="tabs"><button data-view="artem" class="active">Рекомендации Артёма</button><button data-view="idea">Мои идеи</button><button data-view="tasks">Задачи</button><button data-view="memory">Память</button></div>
