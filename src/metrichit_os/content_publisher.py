...
class ContentPublisherStore:
    ...
    def _render(self, topic: str, revision_note: str = "", opening: str | None = None,
        ...
        conclusion = SCHEDULE_CONCLUSIONS.get(clean_topic)
        source_notes = SCHEDULE_INSIGHTS.get(clean_topic)
        expansion = SCHEDULE_EXPANSIONS.get(clean_topic)
        if source_notes and expansion:
