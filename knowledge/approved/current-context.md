...
Сформировано: 2026-08-16T09:55:51.156Z. Этот файл содержит только утверждённую память. Задачи и планы вынесены в отдельный раздел и не являются реализованными фактами.
...
- **SERVER как целевое primary workspace MetricHit:** Серверный перенос больше не на паузе: весь проект «Ядро» будет полностью перенесён на SERVER. После успешной миграции и проверок SERVER становится primary workspace; домашний ПК остаётся резервной точкой до подтверждения миграции. Перенос ещё не выполнен.
