...
| E–G | README вместо реестра, ограничение темы занятым H1, geo только по кластеру — Этап 2 |
| H–K | helpers вне production path, нет durable resume, несогласованная migration и retry identity — Этап 3 |
| N | пять profiles в DB работают в isolated_dag; добавлять агентов не требуется |
...
2. Planner, применимые правила и одна внутренняя структура (E–G).
