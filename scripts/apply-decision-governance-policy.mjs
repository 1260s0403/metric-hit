...
const reviewedAt = '2026-08-31T10:00:00.000Z';
const owner = 'owner';
const revision = 29;
const operationsRevision = 16;
...
export function applyDecisionGovernancePolicy(databasePath = defaultDatabase) {
  ...
  const operationsData = JSON.stringify({
    ...
    repository_mutation: { responsible_executors: 1, commits: 1, in_scope_owner_request_is_authorization: true, redundant_intermediate_confirmation_required: false, parallel_writers_allowed: false },
