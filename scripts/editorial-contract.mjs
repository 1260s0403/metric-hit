...
export function compileEditorialSpec(input, taxonomy) {
  ...
  if (!Number.isInteger(range?.minimum) || (range.maximum !== null && !Number.isInteger(range?.maximum)) || (range.maximum !== null && range.minimum > range.maximum)) specFail('character_range', 'invalid');
  ...
  if ((range.maximum === null || range.maximum > 9000) && !text(input.query_count_rationale)) specFail('secondary_queries', 'query_count_rationale_required_above_9000');
