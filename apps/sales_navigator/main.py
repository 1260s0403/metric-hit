...
SCENARIO = {
    ...
    "qualification": {
        ...
        "manager": "Здравствуйте. Меня зовут [Имя], я из команды MetricHit. Мы занимаемся продвижением сайтов в Яндексе. Подскажите, вы уже продвигаете сайт или это пока в планах?",
