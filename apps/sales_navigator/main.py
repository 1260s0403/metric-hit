...
SCENARIO = {
    ...
    "qualification": {
        "client": "Хорошо, задавайте.",
        "manager": "Первый вопрос: какая цель сейчас важнее — больше заявок, выше конверсия или возврат текущих клиентов?",
        "hint": "Не превращайте разговор в анкету: задавайте один вопрос и слушайте ответ.",
        "choices": [],
    },
}
